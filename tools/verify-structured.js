...
if (!(config.includes("session: ''") || config.includes("session: '/api/session'"))) throw new Error('Config must declare a session endpoint mode');
if (!(config.includes("projects: ''") || config.includes("projects: '/api/projects'"))) throw new Error('Config must declare a cloud projects endpoint mode');
if (!(config.includes("readiness: ''") || config.includes("readiness: '/api/system/readiness'"))) throw new Error('Config must declare a readiness endpoint mode');
if (!(config.includes("startOtp: ''") || config.includes("startOtp: '/api/auth/start'"))) throw new Error('Config must declare auth start endpoint mode');
if (!(config.includes("verifyOtp: ''") || config.includes("verifyOtp: '/api/auth/verify'"))) throw new Error('Config must declare auth verify endpoint mode');
