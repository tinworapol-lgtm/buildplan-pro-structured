...
check('cache-busted-css', html.includes('assets/css/buildplan.css?v=phase77'));
check('today-status-card-cache-bust', html.includes('assets/js/modules/05-gantt-rendering.js?v=phase77') && html.includes('assets/vendor/fonts/ibm-plex-sans-thai.css?v=phase73') && readText('assets/css/buildplan.css').includes('Phase 70: executive style today status card') && readText('assets/css/buildplan.css').includes('Phase 72: 60 percent smaller today status card') && readText('assets/css/buildplan.css').includes('Phase 73: 50 percent larger compact today status') && readText('assets/css/buildplan.css').includes('Phase 74: wider today status equal typography') && readText('assets/css/buildplan.css').includes('Phase 73: IBM Plex Sans Thai global typography') && readText('assets/js/modules/05-gantt-rendering.js').includes('today-popover-card-head'));
