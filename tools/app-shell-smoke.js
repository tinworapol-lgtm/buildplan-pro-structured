...
check('ct-mock-app-script', html.includes('assets/js/services/ct-saas-mock-app.js?v=phase41'));
...
check('cache-busted-css', html.includes('assets/css/buildplan.css?v=phase78'));
check('today-status-card-cache-bust', html.includes('assets/js/modules/05-gantt-rendering.js?v=phase78') && html.includes('assets/vendor/fonts/ibm-plex-sans-thai.css?v=phase73') && readText('assets/css/buildplan.css').includes('Phase 70: executive style today status card') && readText('assets/css/buildplan.css').includes('Phase 72: 60 percent smaller today status card') && readText('assets/css/buildplan.css').includes('Phase 73: 50 percent larger compact today status') && readText('assets/css/buildplan.css').includes('Phase 74: wider today status equal typography') && readText('assets/css/buildplan.css').includes('Phase 73: IBM Plex Sans Thai global typography') && readText('assets/js/modules/05-gantt-rendering.js').includes('today-popover-card-head'));
...
check('phase78-clear-today-layer-toggle-states', html.includes('assets/css/buildplan.css?v=phase78') && html.includes('assets/js/modules/05-gantt-rendering.js?v=phase78') && readText('assets/js/modules/05-gantt-rendering.js').includes("querySelectorAll('.today-line-display-zone')") && readText('assets/css/buildplan.css').includes('Phase 78: clear today layer and explicit toggle states'));
