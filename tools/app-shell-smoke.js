...
check('ct-mock-app-script', html.includes('assets/js/services/ct-saas-mock-app.js?v=phase37'));
...
check('ct-chatbot-markup', html.includes('id="ct-help-chatbot"'));
check('ct-mock-app-script', html.includes('assets/js/services/ct-saas-mock-app.js?v=phase37'));
check('polished-home-copy', html.includes('BuildPlan Pro') && html.includes('เริ่มใช้ฟรี'));
...
check('serverless-saas-mode', readText('assets/js/config/app-config.js').includes('serverless-saas-demo-access'));
