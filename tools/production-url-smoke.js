...
async function main() {
  ...
  const ctMockResponse = await fetch(baseUrl + '/assets/js/services/ct-saas-mock-app.js?v=phase38', {
    headers: { Accept: 'application/javascript' },
  });
  ...
  const checks = [
    ...
    { id: 'has-plan-only-landing', ok: html.includes('ct-reference-landing') && html.includes('ct-login-panel') && html.includes('ct-plan-price-row') && html.includes('data-plan="599"'), detail: 'phase 44 plan-only landing markup' },
    ...
    { id: 'loads-ct-saas-mock-app', ok: html.includes('assets/js/services/ct-saas-mock-app.js?v=phase38'), detail: 'ct-saas-mock-app.js?v=phase38' },
